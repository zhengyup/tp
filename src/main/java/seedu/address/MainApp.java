...
import seedu.address.storage.InternTrackerStorage;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        ...
        InternTrackerStorage addressBookStorage = new JsonInternTrackerStorage(userPrefs.getAddressBookFilePath());
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            addressBookOptional = storage.readInternTracker();
