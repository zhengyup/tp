...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_INTERN_APPLICATION_DISPLAYED_INDEX = "The person index provided is invalid";
    public static final String MESSAGE_INTERN_APPLICATIONS_LISTED_OVERVIEW = "%1$d persons listed!";
