...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_CYCLE_DESC + VALID_ADDRESS_AMY + VALID_ROLE_AMY,
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withRole(VALID_ROLE_BOB).withCycle(VALID_CYCLE_AMY).withAddress(VALID_ADDRESS_AMY)
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + ROLE_DESC_AMY + ADDRESS_DESC_AMY + CYCLE_DESC_AMY
                + TAG_DESC_FRIEND + ROLE_DESC_AMY + ADDRESS_DESC_AMY + CYCLE_DESC_AMY + TAG_DESC_FRIEND
                + ROLE_DESC_BOB + ADDRESS_DESC_BOB + CYCLE_DESC_BOB + TAG_DESC_HUSBAND;

        assertParseFailure(parser, userInput,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_ROLE, PREFIX_CYCLE, PREFIX_ADDRESS));

        // multiple invalid values
        userInput = targetIndex.getOneBased() + INVALID_ROLE_DESC + INVALID_ADDRESS_DESC + INVALID_CYCLE_DESC
                + INVALID_ROLE_DESC + INVALID_ADDRESS_DESC + INVALID_CYCLE_DESC;
