...
public class CommandTestUtil {
    ...
    public static final String VALID_NAME_JANE_STREET = "Jane Street";
    ...
    public static final String NAME_DESC_JANE_STREET = " " + PREFIX_COMPANY + VALID_NAME_JANE_STREET;
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withCompany(VALID_NAME_JANE_STREET)
                .withRole(VALID_ROLE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withCompany(VALID_NAME_GOOGLE)
    ...
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        ...
        InternTracker expectedInternTracker = new InternTracker(actualModel.getAddressBook());
        List<InternApplication> expectedFilteredList = new ArrayList<>(actualModel.getFilteredPersonList());

        assertThrows(CommandException.class, expectedMessage, () -> command.execute(actualModel));
        assertEquals(expectedInternTracker, actualModel.getAddressBook());
