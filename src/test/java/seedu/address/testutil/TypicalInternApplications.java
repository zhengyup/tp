...
public class TypicalInternApplications {
    ...
    public static final InternApplication ALICE =
            new InternApplicationBuilder().withName("Alice Pauline").withAddress("123, Jurong West Ave 6, #08-111")
                    .withCycle("Summer 2024").withRole("SWE Intern").withTags("friends").build();

    public static final InternApplication BENSON =
    ...
    public static final InternApplication ELLE =
            new InternApplicationBuilder().withName("Elle Meyer").withRole("Front End Intern").withCycle("Summer 2021")
                    .withAddress("michegan ave").build();
    public static final InternApplication FIONA =
            new InternApplicationBuilder().withName("Fiona Kunz").withRole("Web Dev Intern").withCycle("Summer 2021")
                    .withAddress("little tokyo").build();
    public static final InternApplication GEORGE =
            new InternApplicationBuilder().withName("George Best").withRole("DevOps Intern").withCycle("Summer 2021")
                    .withAddress("4th street").build();

    // Manually added
    public static final InternApplication HOON =
            new InternApplicationBuilder().withName("Hoon Meier").withRole("8482424").withCycle("Summer 2021")
                    .withAddress("little india").build();
    public static final InternApplication IDA =
            new InternApplicationBuilder().withName("Ida Mueller").withRole("8482131").withCycle("Summer 2021")
                    .withAddress("chicago ave").build();

    // Manually added - Person's details found in {@code CommandTestUtil}
    public static final InternApplication AMY =
            new InternApplicationBuilder().withName(VALID_NAME_AMY).withRole(VALID_ROLE_AMY).withCycle(VALID_CYCLE_AMY)
                    .withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final InternApplication BOB =
            new InternApplicationBuilder().withName(VALID_NAME_BOB).withRole(VALID_ROLE_BOB).withCycle(VALID_CYCLE_BOB)
